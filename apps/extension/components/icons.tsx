// The full icon set shared by the popup and options pages. Every icon takes
// an optional className so call sites can size/animate it; React omits
// className={undefined} entirely, so bare usages render unchanged.
