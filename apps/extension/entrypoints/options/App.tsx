...
function SortingSection({
  ...
  onDefaultSortChange: (value: SortMode) => void;
  onIgnorePinnedChange: (value: boolean) => void;
}) {
  return (
...
function TidySection({
  ...
  minGroupSizeInputRef: RefObject<HTMLInputElement | null>;
  groupOrder: GroupOrder;
  regroupExisting: boolean;
  onCollapseChange: (value: boolean) => void;
  onMinGroupSizeInput: (raw: string) => void;
  onMinGroupSizeBlur: () => void;
  onMinGroupSizeStep: (delta: number) => void;
  onGroupOrderChange: (value: GroupOrder) => void;
  onRegroupChange: (value: boolean) => void;
}) {
  return (
...
function DuplicatesSection({
  ...
  onIgnoreHashChange: (value: boolean) => void;
  onIgnoreQueryChange: (value: boolean) => void;
}) {
  return (
...
function PresetsSection({
  ...
  draft: PresetDraft;
  error: string;
  onDraftChange: (patch: Partial<PresetDraft>) => void;
  onAdd: () => void;
  ...
  return (
    <section aria-labelledby="presets-h" className="settings-section">
      ...
      <div className="preset-form">
        ...
        <button className="btn-filled" disabled={pending} onClick={onAdd} type="button">
          Add preset
        </button>
  ...
  return (
    <main className="page">
      ...
      <TidySection
        ...
        minGroupSizeInputRef={minGroupSizeInputRef}
        onCollapseChange={handleCollapseAfterTidyChange}
        onGroupOrderChange={handleGroupOrderChange}
        onMinGroupSizeBlur={handleMinGroupSizeBlur}
        onMinGroupSizeInput={handleMinGroupSizeInput}
        onMinGroupSizeStep={handleMinGroupSizeStep}
        onRegroupChange={handleRegroupExistingChange}
        pending={pending}
      ...
      <DuplicatesSection
        ...
        onIgnoreHashChange={handleDedupeIgnoreHashChange}
        onIgnoreQueryChange={handleDedupeIgnoreQueryChange}
        pending={pending}
      />
